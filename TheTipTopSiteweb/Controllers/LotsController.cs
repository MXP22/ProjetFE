...
namespace TheTipTopSiteweb.Controllers
{
    public class LotsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Idlot,NomLot,DescriptionLot")] Lot lot)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Idlot,NomLot,DescriptionLot")] Lot lot)
        {
            if (id != lot.Idlot)
            {
                return NotFound();
